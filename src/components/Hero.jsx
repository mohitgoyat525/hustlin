    ...
    <>
      ...
      <div className="w-full max-w-[1920px] mx-auto ">
        <div className="">
          ...
          />
          <h2 className='text-7xl px-4 max-xl:text-6xl max-md:text-4xl max-sm:text-3xl font-normal max-w-[1140px] mx-auto py-16 leading-[140%] max-md:py-14 max-sm:py-10'>
